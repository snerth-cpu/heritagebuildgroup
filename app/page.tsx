...
export default function Home() { return <>
  ...
  <section className="home-cta"><div className="wrap"><div><Mark size="cta" /><p className="eyebrow">START A CONVERSATION</p><h2>TELL US ABOUT YOUR PROJECT.</h2></div><Button href={ESTIMATE_HREF} light>REQUEST AN ESTIMATE</Button></div></section>
  </> }
