...
const services = [
  ...
  ["METAL SIDING", "Durable metal siding and trim with a clean, finished look.", "/metal-siding", "siding"],
  ["COMMERCIAL", "Roofing, siding, trim, and complete exterior projects.", "/commercial", "commercial"],
] as const;
...
export default function Home() { return <>
  ...
  <section className="home-markets"><div className="wrap home-markets__grid"><article><p className="eyebrow">RESIDENTIAL</p><h2>FOR YOUR HOME.</h2><p>Metal roofing and siding planned around your home and how you want it to look when the job is done.</p><Button href={ESTIMATE_HREF} light>REQUEST AN ESTIMATE</Button></article><article><p className="eyebrow">COMMERCIAL</p><h2>FOR YOUR PROPERTY.</h2><p>Metal roofing and siding for commercial buildings—from a focused upgrade to a full exterior project.</p><Button href="/commercial" light>COMMERCIAL SERVICES</Button></article></div></section>
