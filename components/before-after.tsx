...
export function BeforeAfter() {
  ...
  return <div className="before-after" style={{ "--position": `${position}%` } as React.CSSProperties}>
    <Image src="/images/01_finished_exterior_hero.jpeg" alt="Completed black metal exterior after renovation" fill sizes="(max-width: 800px) 100vw, 1240px" />
    <div className="before-after__before"><Image src="/images/02_before_front.jpeg" alt="Building exterior before renovation" fill sizes="(max-width: 800px) 100vw, 1240px" /></div>
