...
export function LocationPage({ location }: { location: LocationContent }) {
  return <>
    ...
    <section className="location-copy wrap"><div className="location-copy__intro"><p className="eyebrow">LOCAL METAL EXTERIOR WORK</p><p className="lead">{location.lead}</p></div>
