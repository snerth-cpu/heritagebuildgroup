...
export function LocationPage({ location }: { location: LocationContent }) {
  return <>
    ...
    <section className="location-copy wrap"><div className="location-copy__intro"><p className="eyebrow">LOCAL CONSTRUCTION SERVICES</p><p className="lead">{location.lead}</p></div>
