...
import { BUSINESS_EMAIL, BUSINESS_PHONE, BUSINESS_PHONE_HREF, CONTACT_HREF, ESTIMATE_HREF, LEGAL_NAME, SITE_NAME } from "@/lib/seo";
...
export function Mark({ compact = false }: { compact?: boolean }) {
  return <span className={`brand ${compact ? "brand--compact" : ""}`} aria-label={SITE_NAME}>
    <Image className="brand__image" src={compact ? "/brand/hbg-monogram.png" : "/brand/hbg-primary.png"} width={compact ? 48 : 92} height={compact ? 48 : 92} alt={`${SITE_NAME} logo`} priority />
  </span>;
}
